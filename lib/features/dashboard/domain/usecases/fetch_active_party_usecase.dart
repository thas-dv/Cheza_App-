...
class FetchActivePartyUseCase {
  const FetchActivePartyUseCase(this._repository);

  final DashboardRepository _repository;

  Future<PartySummary?> call(int placeId) {
    return _repository.fetchActiveParty(placeId);
  }
}